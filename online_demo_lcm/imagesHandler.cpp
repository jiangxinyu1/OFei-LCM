...
extern uint8_t raw12_img[336*639];
extern char ir_image[224*70];
extern char depth_image[224*70*2];
extern char pcloud_image[224*70*sizeof(pc_pkt_t)];
extern char depth_data[224*70*sizeof(depth_data_pkt_t)];
...
int pubImagesRealtime(struct camera_hal *camera ,imagesHandler &handler)
{
	...
	while (handler.isLcmOk())
	{
		...
		/* Save others */
        handler.getTime();
        handler.pubDepthImage(depth_image,224,70,224*70,"depth");
        handler.pubIRImage(ir_image,224,70,224*70,"ir");
